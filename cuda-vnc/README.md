cuda-vnc
========
Ubuntu Core 14.04 + CUDA 7.0.28 + LXDE desktop + Firefox browser + TightVNC server. Requires the host has the corresponding CUDA drivers (v. 346.46) installed for the kernel module. Runs as a daemon by default by using tail. 
