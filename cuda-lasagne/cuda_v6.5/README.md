...
cuda-lasagne
============
Ubuntu Core 14.04 + [CUDA 6.5.14](http://www.nvidia.com/object/cuda_home_new.html) + [cuDNN v4](https://developer.nvidia.com/cuDNN) + [Lasagne](http://lasagne.readthedocs.org/).
